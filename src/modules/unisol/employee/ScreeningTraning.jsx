...
import ScreeningBackgroundPic from "../../../assets/images/screening.png"

const ScreeningTraning = () => {
        ...
        <div className="flex  flex-col bg-white p-[50px] rounded-2xl gap-8">
          ...
          <div className="p-[50px] border border-gray-300 flex flex-col items-center justify-center">
            <img
              ...
              src={ ScreeningBackgroundPic}
              alt=""
            />
            <h2 className=" mt-1 font-normal text-xl text-balance ">No record to display here</h2>
          </div>
        </div>
      );
}

export default ScreeningTraning