...
import PaySlip from "./../../../components/Dialogs/Payslip";
...
const PayslipGenration = () => {
  ...
  const { FetchPayslipGenerationStatusList, payslipGenerationStatusList } =
  ...
  return (
    <div className="min-h-screen w-full">
      <Breadcrumb
        linkText={[
          { text: "Payroll Management", href: "/paySlip" },
          { text: "Pay Slip Generation Status", href: "/paySlip" },
        ]}
      />
      <div className="w-full bg-white rounded-2xl overflow-hidden">
          ...
          <TableContainer sx={{ maxHeight: 475 }}>
            <Table stickyHeader sx={{ minWidth: 650 }} aria-label="simple table">
              <TableHead className="bg-gray-100">
                <TableRow>
                  <TableCell align="center" sx={{ fontWeight: 600, fontSize: "16px" }}>Employee Name</TableCell>
                  <TableCell align="center" sx={{ fontWeight: 600, fontSize: "16px" }}>Employee ID</TableCell>
                  <TableCell align="center" sx={{ fontWeight: 600, fontSize: "16px" }}>Pay Slip Status</TableCell>
                  <TableCell align="center" sx={{ fontWeight: 600, fontSize: "16px" }}>Action</TableCell>
                </TableRow>
              </TableHead>
                ...
                {payslipGenerationStatusList?.data?.employees?.map((list) => (
                  <TableRow key={list?.empId}>
                    ...
                    <TableCell align="center">
                      <button
                        className={`py-1 px-4 rounded-md ${list?.paySlipStatus === "Generated"
        ...
        <Pagination
          currentPage={payslipGenerationStatusList?.data?.pagination?.currentPage}
          totalPages={payslipGenerationStatusList?.data?.pagination?.totalPages}
          totalItems={payslipGenerationStatusList?.data?.employees.length}
